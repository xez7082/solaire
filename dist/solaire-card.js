(function() {
  ...
  // ... (METEO_DATA reste identique)
  const METEO_DATA = { 'clear-night': { n: 'Nuit claire', i: 'weather-night', c: '#ffeb3b', a: 'float' }, 'cloudy': { n: 'Nuageux', i: 'weather-cloudy', c: '#90a4ae', a: 'float' }, 'fog': { n: 'Brouillard', i: 'weather-fog', c: '#b0bec5', a: 'float' }, 'hail': { n: 'Grêle', i: 'weather-hail', c: '#4fc3f7', a: 'pulse' }, 'lightning': { n: 'Orages', i: 'weather-lightning', c: '#ffeb3b', a: 'pulse' }, 'lightning-rain': { n: 'Orages pluvieux', i: 'weather-lightning-rain', c: '#ffeb3b', a: 'pulse' }, 'partlycloudy': { n: 'Partiellement nuageux', i: 'weather-partly-cloudy', c: '#cfd8dc', a: 'float' }, 'pouring': { n: 'Averses', i: 'weather-pouring', c: '#2196f3', a: 'pulse' }, 'rainy': { n: 'Pluvieux', i: 'weather-rainy', c: '#42a5f5', a: 'pulse' }, 'snowy': { n: 'Neigeux', i: 'weather-snowy', c: '#fff', a: 'float' }, 'snowy-rainy': { n: 'Pluie et neige', i: 'weather-snowy-rainy', c: '#e1f5fe', a: 'pulse' }, 'sunny': { n: 'Ensoleillé', i: 'weather-sunny', c: '#ffce20', a: 'spin' }, 'windy': { n: 'Venteux', i: 'weather-windy', c: '#80deea', a: 'float' }, 'windy-variant': { n: 'Venteux', i: 'weather-windy-variant', c: '#80deea', a: 'float' }, 'exceptional': { n: 'Alerte', i: 'alert-circle', c: '#f44336', a: 'pulse' } };
  ...
  class SolaireCard extends LitElement {
    ...
    _renderSpark(p) {
        ...
        if (!trigger || trigger.state !== 'on') return '';
        ...
        return html`
            <div class="real-spark" style="left:${c[p+'_x']}px; top:${c[p+'_y']}px; --spark-color:${color}; --spark-size:${size}px;">
                ...
                <div class="s-arm a1"></div>
                <div class="s-arm a2"></div>
                <div class="s-arm a3"></div>
                <div class="s-arm a4"></div>
            </div>`;
    }
    ...
    static get styles() { return css`
      ...
      /* ARC ELECTRIQUE DESIGN */
      .real-spark { position: absolute; width: var(--spark-size); height: var(--spark-size); z-index: 50; display: flex; align-items: center; justify-content: center; animation: crackle 0.15s steps(2) infinite; }
      ...
      .a1, .a3 { width: 100%; height: 1px; }
      .a2, .a4 { width: 1px; height: 100%; }
  ...
  window.customCards.push({ type: "solaire-card", name: "Solaire V280 Real Spark" });
})();
