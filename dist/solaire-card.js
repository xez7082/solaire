(function() {
  ...
  class SolaireCard extends LitElement {
    ...
    render() {
      ...
      return html`
        <ha-card style="width:100%; max-width:${c.card_width}px; aspect-ratio:${c.card_width}/${c.card_height}; background:#000; border:none; margin: auto;">
          <img src="${c.background_image}" class="bg-img">
          <canvas id="flowCanvas" width="${c.card_width}" height="${c.card_height}"></canvas>
          <div class="layer" style="transform: scale(calc(var(--card-current-width, ${c.card_width}) / ${c.card_width})); transform-origin: top left;">
    ...
    static get styles() { return css`
      ha-card { position: relative; overflow: hidden; display: block; }
      .bg-img { position: absolute; width: 100%; height: 100%; object-fit: contain; z-index: 1; top:0; left:0; }
      #flowCanvas { position: absolute; z-index: 5; pointer-events: none; width: 100%; height: 100%; }
      .layer { position: absolute; width: 100%; height: 100%; z-index: 10; pointer-events: none; top:0; left:0; }
